        ...
        return (
            <div>
                {!this.props.books.length ? (
                    <h3 className="text-center"> Your library is empty </h3>
                ) : (
                        <div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-10">
                                            <div className="card-body">
                                                ...
                                                <div>
                                                    <a href={result.link} className="btn badge btn-outline-dark mt-3" target="_blank"> View </a>
                                                    <button onClick={() => this.handleSave(result)} className="btn badge btn-outline-danger mt-3 ml-3"> 
